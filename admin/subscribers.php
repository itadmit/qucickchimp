...
// Set page title
$pageTitle = 'ניהול מנויים';
$pageDescription = 'צפייה וניהול של מנויים במערכת';
$primaryAction = [
...
if (isset($_GET['delete']) && !empty($_GET['delete'])) {
    ...
    if ($canDelete) {
        ...
        if ($stmt->execute([$subscriberId, $userId])) {
            $_SESSION['success'] = 'המנוי נמחק בהצלחה';
        } else {
            $_SESSION['error'] = 'אירעה שגיאה בעת מחיקת המנוי';
        }
    } else {
        $_SESSION['error'] = 'אין לך הרשאה למחוק מנוי זה';
    }
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="flex justify-between items-center p-4 border-b">
        <div>
            <h2 class="text-lg font-medium">רשימת מנויים</h2>
            <p class="text-sm text-gray-500">סה"כ <?php echo $totalCount; ?> מנויים</p>
        </div>
    ...
    <?php if (empty($subscribers)): ?>
        <div class="p-8 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-700 mb-2">אין מנויים עדיין</h3>
            <p class="text-gray-500 mb-6">כאן תוכל לראות את כל המנויים שלך לאחר שיירשמו באמצעות דפי הנחיתה שלך.</p>
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="bg-gray-50">
                        ...
                        <th class="px-4 py-3 text-right text-sm font-medium text-gray-500">מנוי</th>
